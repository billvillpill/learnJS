...
If the character is "+" , "-", "*", or "/", the function will return the result of the corresponding mathematical function
on the two numbers.
...
function calculate(num1, operation, num2) {
    let str = '';
    return num2 == 0 && operation === '/' ? null : /[+-/*]/g.test(operation) ? eval(num1 + operation + num2) : null
}

console.log(calculate(2, '-', 1)); // true