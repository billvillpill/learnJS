 ...
 * @param {*тип параметра number} numberOne 
 * @param {*тип параметра number} numberTwo 
 * @returns {*тип возвращаемого параметра number} - Разница чисел
 */
const differenceNumbers = (numberOne, numberTwo) => numberOne - numberTwo
console.log(differenceNumbers(10, 4))