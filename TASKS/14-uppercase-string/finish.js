 ...
 */
const mySport = "basketball"

console.log(mySport instanceof String) // определяет является ли переменная классом String
console.log(typeof mySport)             // тип переменной 
const upSport = mySport.toUpperCase()
console.log(upSport)
