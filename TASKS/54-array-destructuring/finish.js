...
const processQuantities = ([minQty, maxQty, defaultQty = 0] = inputQuantities1) => {
...
console.log('Первый вызов:',processQuantities(inputQuantities1)) // 31

const inputQuantities2 = [8, 29]
console.log('Второй вызов:', processQuantities(inputQuantities2)) // 21
